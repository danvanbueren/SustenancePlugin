...
public class SusStatuslist {
    public static void goCode(CommandSender sender, Command command, String label, String[] args) {
        ...
        for(Player p : Bukkit.getOnlinePlayers()) {
            playersAdded = true;
            message.append("'").append(p.getName()).append("': ").append(Sustenance.nutritionManager.getPlayerNutrition(p).getFormattedNutrition()).append("\n");
        }
        ...
        Sustenance.messagingManager.info(message.toString(), sender);
